...
const Home = () => {
  ...
  const sortedProducts = useMemo(() => {
    ...
    const withFallbackAsc = (value: number | undefined) => (typeof value === 'number' && Number.isFinite(value) ? value : Number.POSITIVE_INFINITY);
    const withFallbackDesc = (value: number | undefined) => (typeof value === 'number' && Number.isFinite(value) ? value : Number.NEGATIVE_INFINITY);
